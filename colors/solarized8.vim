...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    if s:termtrans
      ...
      hi Folded guifg=fg guibg=NONE guisp=#00242a gui=bold cterm=bold
    ...
    if get(g:, 'solarized_old_cursor_style', 0)
      hi Cursor guifg=#00242a guibg=#839496 gui=NONE cterm=NONE
    else
    ...
    if has('nvim')
      ...
      hi TermCursorNC guifg=#00242a guibg=#586e75 gui=NONE cterm=NONE
    endif
...
" Color: base03   #00242a   235      8
" Color: back     #00242a   235      8
